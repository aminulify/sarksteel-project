...
const Navbar = () => {
    return ( 
        <div className='fixed w-full z-10'>
            ...
            <div className="flex justify-between mx-auto items-center max-w-[1150px]">
            {/* left side  */}
                <div>
                ...
                <div>
                    <div className='uppercase list-none flex gap-3 text-[var(--secondaryColor)]'>
                        ...
                        <li className='py-2 px-4 flex items-center cursor-pointer'><Link href={"/"}>Services </Link><IoIosArrowDown className='hover:rotate-180'/></li>
