...
const Header = () => {
    return (
        <div className='headerImg flex items-center justify-center text-center'>
            ...
            <Link href={'/services'} className="flex gap-1 items-center text-white py-2 px-8 mt-6 border-2 border-white rounded-full duration-300 hover:gap-3 md:text-lg hover:backdrop-blur-xs cursor-pointer">Read More <FaArrowRight/></Link>
            </div>
        </div>
    );
};
